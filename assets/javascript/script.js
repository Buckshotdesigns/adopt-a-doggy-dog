...
function displayAll() {
  ...
  for (var i = 0; i < 8; i++) {
    ...
    $("#dog-pic").attr({
      "data-name": dogName,
      "data-age": dogAge,
      "data-gender": dogGender,
      "data-description": dogDescription,
      "data-email": dogEmail,
      "data-url": dogUrl,
    });
  }
...
$(document).ready(function () {
  $(".dropdown-item").on("click", function (event) {
    ...
    var queryUrl =
      "https://en.wikipedia.org/w/api.php?action=query&origin=*&format=json&action=query&prop=extracts&exintro&explaintext&redirects=5&titles=" +
      dogBreed[getDog].dog;
    ...
    if (breed == "myModal") {
      ...
      //     dataType: 'jsonp',
      //     method: "GET"
      var key = "K0NfPXHaiN2H6oyk1o8KzM3hlhOQcKLjXoim3rEwmHA4J9HZIL";
      var secret = "0sOUca886IH2rTQSue78rurEt18ZMBoNEMk9zhLr";
      fetch("https://api.petfinder.com/v2/oauth2/token", {
        ...
        .then(function (data) {
          ...
          return fetch(
            "https://api.petfinder.com/v2/animals?type=dog&location=cleveland, ohio;&breed=" +
              breed +
              "&limit=20",
            {
              headers: {
...
$("body").on("click", "#dog-pic", function () {
  ...
  captionText.append(
    "<a href='" +
      dataUrl +
      "' target='_blank'><button class='btn btn-primary more-info'>More info</button></a>"
  );
});
